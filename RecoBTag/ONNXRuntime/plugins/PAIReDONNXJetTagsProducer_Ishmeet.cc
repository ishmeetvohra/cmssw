...
private:
  ...
  std::vector<std::string> input_names = {"cpf", "cpf_4v", "sv", "sv_4v"};
...
void PAIReDONNXJetTagsProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<edm::FileInPath>("model_path", edm::FileInPath("RecoBTag/Combined/data/PAIReD/PAIReD_6class_ak4_clustered/best_model.onnx")); // put my onnx mdoel in RecoBTag/Combined/data/PAIReD
